	...
	const songs: I_MusicList[] = [
		{
			...
			styles: [MusicStyles.AlternativeRock, MusicStyles.HipHop, MusicStyles.House],
		}, {
			...
			year: 2006,
			genre: [MusicGenres.Rock],
			styles: [MusicStyles.AlternativeRock],
		}, {
			...
			year: 2005,
			genre: [MusicGenres.Rock, MusicGenres.Metal],
			styles: [MusicStyles.HardRock, MusicStyles.NuMetal],
		}, {
			...
			year: 2000,
			genre: [MusicGenres.Rock, MusicGenres.Metal],
			styles: [MusicStyles.HardRock, MusicStyles.HeavyMetal],
		}, {
			...
			year: 2001,
			genre: [MusicGenres.Rock],
			styles: [MusicStyles.HardRock, MusicStyles.AlternativeRock, MusicStyles.ProgRock],
		}, {
			...
			name: "B.Y.O.B.",
			genre: [MusicGenres.Rock, MusicGenres.Metal],
			styles: [MusicStyles.AlternativeRock, MusicStyles.NuMetal, MusicStyles.HardRock, MusicStyles.HeavyMetal],
		}, {
			...
			year: 2006,
			genre: [MusicGenres.Rock],
			styles: [MusicStyles.Hardcore, MusicStyles.Punk],
		}, {
			...
			genre: [MusicGenres.HipHop, MusicGenres.Rap],
			styles: [],
		}, {
			...
			year: 2008,
			genre: [MusicGenres.Rock],
			styles: [MusicStyles.AlternativeRock, MusicStyles.Punk],
		}, {
			...
			genre: [MusicGenres.Rock, MusicGenres.Metal],
			styles: [MusicStyles.FolkMetal, MusicStyles.HeavyMetal, MusicStyles.PirateMetal],
		}, {
			...
			year: 2022,
			name: "Bury Me",
			genre: [MusicGenres.Metal, MusicGenres.Rock],
			styles: [MusicStyles.SymphonicMetal],
		}, {
			...
			year: 2009,
			genre: [MusicGenres.Rock, MusicGenres.Reggae, MusicGenres.FunkSlashSoul],
			styles: [MusicStyles.IndieRock, MusicStyles.NeoSoul],
		}, {
			...
			genre: [MusicGenres.Folk, MusicGenres.World, MusicGenres.Country],
			styles: [MusicStyles.Folk],
		}, {
			ytmusic: "https://music.youtube.com/watch?v=UzubmuEhzdE&si=Xs5r5ZP5sYVem0Pu",
			artist: "Rumahoy",
			album: "Time II: Party",
			year: 2019,
			name: "The Legend of Captain Yarrface",
			genre: [MusicGenres.Rock, MusicGenres.Metal],
			styles: [MusicStyles.FolkMetal, MusicStyles.HeavyMetal, MusicStyles.PirateMetal],
		}, {
			ytmusic: "https://music.youtube.com/watch?v=NoyJgR_09Vw&si=OXR5M-Knq6OEApvs",
