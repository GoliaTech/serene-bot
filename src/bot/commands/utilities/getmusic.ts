...
import { ChatInputCommandInteraction, ActionRowBuilder, ButtonBuilder, ButtonStyle, Message, MessageActionRowComponentBuilder } from "discord.js";
...
const getMusic: I_Command = {
	data: commandBuilder(
		"getmusic",
		"Fetch and display all music in the database."
	),
	async execute(interaction: ChatInputCommandInteraction) {
		...
		if (!songs.length) {
			return interaction.reply({ content: "No songs found.", ephemeral: true });
		}
